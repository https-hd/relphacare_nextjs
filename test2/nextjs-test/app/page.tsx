...
const FragrancesPage = () => {
  return (
    <div className="bg-gradient-to-t to-yellow-100 from-purple-400 flex flex-col text-black min-h-screen justify-center items-center relative">
      ...
      {/* Heading */}
      <h1 className="[rgba(58, 36, 113, 1)] font-poppins text-[64px] font-semibold text-center mb-40 px-8 absolute top-0 p-5">Exercises</h1>
      ...
      <div className="grid grid-cols-4 gap-10 mt-30">
        {/* Fragrance Items */}
        <FragranceItem title="Zen Calm" imageSrc="../images/MainMenuImages/Exercises.svg" />
        <FragranceItem title="Mindfulness Journey" imageSrc="../images/MainMenuImages/Exercises.svg" />
        <FragranceItem title="Serenity Now" imageSrc="../images/MainMenuImages/Exercises.svg" />
        <FragranceItem title="Tranquil Waters" imageSrc="../images/MainMenuImages/Exercises.svg" />
      </div>
    </div>
  );
};
